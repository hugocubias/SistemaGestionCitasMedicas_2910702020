...
namespace SistemaGestionCitasMedicas
{
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Especialidad,Horario")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Especialidad,Horario")] Medico medico)
        {
            if (id != medico.Id)
            {
                return NotFound();
