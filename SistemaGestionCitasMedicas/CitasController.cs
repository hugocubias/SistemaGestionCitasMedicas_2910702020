...
namespace SistemaGestionCitasMedicas.Controllers
{
    public class CitasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaHora,PacienteId,MedicoId,Nombre")] Cita cita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FechaHora,PacienteId,MedicoId,Nombre")] Cita cita)
        {
